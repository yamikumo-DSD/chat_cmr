...
class LlamaCppSpecial(Llama):
    ...
    def _create_completion(
        ...
        # Here bos_tokens and eos_tokens are added to the original prompt.
        ...
        for token in self.generate(
            ...
            for k, char in enumerate(all_text[-3:]):
                ...
                for num, pattern in [(2, 192), (3, 224), (4, 240)]:
                    # Bitwise AND check
                    # This might help: https://stackoverflow.com/questions/44565859/how-does-utf-8-encoding-identify-single-byte-and-double-byte-characters
                    # pattern & char with an example "あ" (3-bytes char)
                    # print("あ".encode())          # b'\xe3\x81\x82'
                    # print(192 & "あ".encode()[0]) # 11000000(192) & 1110xxxx(xE3) -> 11000000(192)
                    # print(224 & "あ".encode()[0]) # 11100000(224) & 1110xxxx(x81) -> 11100000(224)
                    # print(240 & "あ".encode()[0]) # 11110000(240) & 1110xxxx(x82) -> 11100000(224)
